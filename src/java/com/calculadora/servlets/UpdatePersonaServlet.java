...
import com.calculadora.classes.*;
...
public class UpdatePersonaServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            Person p = dbHelper.getPersonById(Integer.parseInt(person_id));
            out.write(p.toJSON());
            dbHelper.endConnection();
        } catch (Exception ex) {
            Map message = new HashMap();
            message.put("message", "Ocurrio un error en el servidor: "+ex.getMessage());
